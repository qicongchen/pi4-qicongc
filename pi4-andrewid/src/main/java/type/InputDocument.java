...
public class InputDocument extends ComponentAnnotation {
  ...
  */  
   ...
   * @return value of the feature 
   */
  public FSList getDictionary() {
    if (InputDocument_Type.featOkTst && ((InputDocument_Type)jcasType).casFeat_dictionary == null)
      jcasType.jcas.throwFeatMissing("dictionary", "type.InputDocument");
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((InputDocument_Type)jcasType).casFeatCode_dictionary)));}
    
  /** setter for dictionary - sets  
   * @generated
   * @param v value to set into the feature 
   */
  public void setDictionary(FSList v) {
    if (InputDocument_Type.featOkTst && ((InputDocument_Type)jcasType).casFeat_dictionary == null)
      jcasType.jcas.throwFeatMissing("dictionary", "type.InputDocument");
    jcasType.ll_cas.ll_setRefValue(addr, ((InputDocument_Type)jcasType).casFeatCode_dictionary, jcasType.ll_cas.ll_getFSRef(v));}    
  }
